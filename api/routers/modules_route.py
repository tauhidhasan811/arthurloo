...
route = APIRouter(prefix='/api/ai/v1/workflow/run', tags=["All module"])

executer = WorkFlowExecuter()
@route.post('/all-module/')
async def run_all_module(module_data: AllModuleData):
    try:
        ...
        PA_status, PA_run_id = executer.run_workflow("personal_ability", personality_and_interest_data.dict())
